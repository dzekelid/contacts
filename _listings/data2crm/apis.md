...
apis:
- name: Data2CRM.API - GET for Contact
...
- name: Data2CRM.API - POST for Contact
...
- name: Data2CRM.API - COUNT for Contact
  x-api-slug: contactcount-get
...
- name: Data2CRM.API - DESCRIBE for Contact
  x-api-slug: contactdescribe-get
...
- name: Data2CRM.API - DELETE for Contact
  x-api-slug: contactcontact-id-delete
...
- name: Data2CRM.API - GET for Contact
  x-api-slug: contactcontact-id-get
...
- name: Data2CRM.API - PUT for Contact
  x-api-slug: contactcontact-id-put
