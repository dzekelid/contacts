...
- name: Elastic Email SMTP API Create Multiple Subscriber From CSV File
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/contacts/master/_listings/elastic-email/listsuploadcontacts-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/contacts/master/_listings/elastic-email/listsuploadcontacts-get-openapi.md
- name: Elastic Email SMTP API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/contacts/master/_listings/elastic-email/openapi.md
x-common:
- type: x-base
